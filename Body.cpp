...
{
    const Vec3 temporary = worldPoint - GetCenterOfMassWorldSpace();
    const Quat invertOrientation = orientation.Inverse();

    Vec3 bodySpace = invertOrientation.RotatePoint(temporary);
